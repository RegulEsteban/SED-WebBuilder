...
(function(f) {
    ...
    r(A.lang, {
        ...
        downloadSVG: "Descargar como vector SVG",
        contextButtonTitle: "Herramientas de descarga"
    });
    A.navigation = {
        menuStyle: {
    ...
    r(C.prototype, {
        ...
        getSVG: function(a) {
            var b = this,
                ...
                d.title.text = unescape(encodeURIComponent(d.title.text));
                d.yAxis[0].title.text = unescape(encodeURIComponent(d.yAxis[0].title.text));
                d.series[2].name = unescape(encodeURIComponent(d.series[2].name));
