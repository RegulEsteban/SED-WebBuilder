(function($){
	$(function(){
	  ...
	  var menu_head = $('ul.side-menu h2.title-side-menu').height();
    ...
    $(document).mouseup(function (e) {
      ...
      if ((!container.is(e.target) && container.has(e.target).length === 0) && 
        ...
        $('body, ul.side-menu').removeClass("open-side-menu");
    ...
    $("a.menu-icon").click(function(e) {
      e.preventDefault();
      if ($('ul.side-menu, body').hasClass('open-side-menu')) {
	      ...
	      $('ul.side-menu').addClass('open-side-menu');
